---
layout: post
title: "Le principali novità di Ableton Live 12"
...
Uno dei problemi più diffusi tra i producer è la scelta del suono giusto: in Live 12 è stata aggiunta una nuova funzione di ricerca che, sfruttando degli algoritmi di _machine learning_, trova all’interno della vostra libreria suoni, preset e campioni con caratteristiche sonore simili a quello selezionato come riferimento.
...
In Live 12 abbiamo ora una serie di&nbsp;_trasformazioni_&nbsp;e&nbsp;_generatori_&nbsp;MIDI. Le trasformazioni ci permettono di agire sul contenuto esistente di una clip MIDI mentre i generatori sono pensati per creare idee da zero.
