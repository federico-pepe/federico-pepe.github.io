---
layout: post
title: "Ableton Push 3 è arrivato"
...
Approfitto anche di questo mio spazio personale per fare chiarezza su alcuni aspetti molto commentati e criticati nei vari forum e gruppi online perché talvolta è davvero difficile rispondere a tuttə. Se volete saltare direttamente a questa parte, [cliccate qui](#pareri).
...
La contropartita, però, era un prezzo più elevato rispetto ad altri controller sul mercato. Per fare giusto un paio di esempi Push 2 costava EUR 699,00 mentre l'[AKAI APC40 MKII](https://www.akaipro.com/apc40-mkii), considerato da molti il più diretto competitor a livello di funzionalità, ha un prezzo di EUR 429,00. Il [Launchpad Pro X MKIII](https://novationmusic.com/en/launch/launchpad-pro) della Novation, invece, viene a costare EUR 349,00 (fonte Strumentimusicali.it).
...
Lo dico già ora e lo ripeterò dopo: se avete già una licenza di Live 11 sul vostro account **non dovete** acquistarne un'altra ma potete semplicemente autorizzarla su Push. Ho spiegato come fare in [questo video](https://www.youtube.com/watch?v=oEtUeCnXPKg).
...
[![Foto della parte alta di Ableton Push 3 in cui vengono mostrate tutte le connessioni](/assets/uploads/2023/05/3_Ableton-Push3-1024x768.webp)](/assets/uploads/2023/05/3_Ableton-Push3-scaled.webp)
...
Lo dicevo all'inizio e lo ribadisco qui: Ableton Push 3 è uno **strumento** _premium_ rivolto principalmente a chi già usa Live o chi vuole integrare Live nel proprio setup in studio o dal vivo. Rispetto al passato, il fatto che esista una configurazione Standalone, permetterà anche a chi non conosce Live di integrarlo nel proprio workflow.
...
Il fatto che dentro a Push 3 (standalone) ci giri una versione di Live completa non fa altro che _espandere_ le potenzialità di questo strumento. È vero, non c'è uno schermo più grande né un'uscita HDMI ma meglio così.
...
Penso che l'esempio migliore sia il [video di Loopop](https://youtu.be/Lr2ID82WncY?t=2320) in cui fa il paragone tra il consumo di CPU del medesimo set su Push 3 e su un MacBook Pro M1 Max con 32GB di RAM.
...
Detto questo se volete rimanere aggiornatə ho già pianificato una serie di video che finiranno sul canale YouTube degli [Ableton Certified Trainer](https://www.youtube.com/@abletoncertifiedtraineritalia) e potete sempre iscrivervi [alla newsletter qui](http://bit.ly/AbletonNewsletterITA).
